...
@section('content')
    <div class="box">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <table id="pics-table" class="table table-striped">
                <thead>
                <tr>
                    <th>No.</th>
                    <th>ID Karyawan</th>
    ...
    <script type="text/javascript">
        var table = $('#pics-table').DataTable({
            ...
            columns: [
                ...
                {data: 'idkaryawan', name: 'idkaryawan'},
        ...
        $(function(){
            $('#modal-form form').validator().on('submit', function (e) {
                if (!e.isDefaultPrevented()){
                    var id = $('#id').val();
                    if (save_method == 'add') url = "{{ url('pics') }}";
                    else url = "{{ url('pics') . '/' }}" + id;
...
//                      data : $('#modal-form form').serialize(),
                        ...
                        error:function (response) {
                            $('#idkError').text(response.responseJSON.errors.idkaryawan);
                            $('#namaError').text(response.responseJSON.errors.nama_pic);
